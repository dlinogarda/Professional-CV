...
\cvjobtitle{Researcher}         % your actual job position

\cvmail{dlinogarda@gmail.com}
\cvmaill{p68077022@gs.ncku.edu.tw}
...
{\huge\color{mainblue}Lino Garda Denaro, B.Eng, M.Sc, Ph.D}

\begin{flushright}
{\small\color{mainblue}Science of Geomatics}
\end{flushright}
